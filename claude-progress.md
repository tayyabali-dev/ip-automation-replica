...
- **Batman/Gotham Theme** (Current Active Theme)
  - **Color scheme**: Batman/Gotham colors
  ...
  - **Custom SVG icons**: `BatmanLogo` and `BatSignalLogo` components
  ...
  - **Navigation config**: Labels ("Batcave", "New Case", "Crime Analysis", "Case Files", "Bat Signal", "Batcomputer", "Alfred")
  ...
  - **DashboardLayout**: Gotham City background pattern

- **Previous Theme Explorations**:
  - Star Wars theme (replaced by Pokemon)
  - Pokemon theme (replaced by Batman)
  - Batman theme (replaced by Superman)
  - Superman theme (reverted back to Batman - current)
...
- Notifications page still uses old color variables - needs to be updated to Batman colors
- Dashboard page may still have some Superman references that need updating
...
- Dark, noir aesthetic inspired by Batman's vigilante persona
